...
const CATALOG: { name: string; sku: string; category: string; basePrice: number; marketplace: MarketplaceKey }[] = [
  ...
  { name: 'TV 50" 4K UHD Smart LED',         sku: 'MG-TV-001',  category: 'Eletrodomésticos', basePrice: 1999.0, marketplace: 'magalu' },
  { name: 'Ar Condicionado 12000 BTUs',       sku: 'MG-ARC-004', category: 'Eletrodomésticos', basePrice: 1499.0, marketplace: 'magalu' },
  { name: 'Air Fryer 5L Digital',             sku: 'MG-FRI-008', category: 'Eletrodomésticos', basePrice: 399.9,  marketplace: 'magalu' },
  { name: 'Cafeteira Expresso 15 Bar',        sku: 'MG-CAF-007', category: 'Eletrodomésticos', basePrice: 449.9,  marketplace: 'magalu' },
  { name: 'Tênis Casual Feminino',            sku: 'AM-TEN-004', category: 'Moda',             basePrice: 179.9,  marketplace: 'americanas' },
  { name: 'Camiseta Polo Masculina',          sku: 'AM-CAM-005', category: 'Moda',             basePrice: 79.9,   marketplace: 'americanas' },
  { name: 'Bolsa Feminina Couro Sintético',   sku: 'AM-BOL-006', category: 'Moda',             basePrice: 149.9,  marketplace: 'americanas' },
  { name: 'Perfume Masculino 100ml',          sku: 'AM-PER-001', category: 'Beleza',           basePrice: 299.9,  marketplace: 'americanas' },
  { name: 'Sofá Retrátil 3 Lugares',         sku: 'CB-SOF-001', category: 'Móveis',           basePrice: 1899.0, marketplace: 'casasbabia' },
  { name: 'Mesa de Jantar 6 Lugares',         sku: 'CB-MES-003', category: 'Móveis',           basePrice: 1599.0, marketplace: 'casasbabia' },
  { name: 'Guarda-Roupa 6 Portas',            sku: 'CB-GUA-004', category: 'Móveis',           basePrice: 999.0,  marketplace: 'casasbabia' },
