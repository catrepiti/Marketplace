...
const SEED_DATA: SeedRow[] = [
  ...
  // ── Magalu ────────────────────────────────────────────────────────────────
  { id:'18', sku:'MG-TV-001',  name:'TV 50" 4K UHD Smart LED',        category:'Eletrodomésticos', marketplace:'magalu',       quantity:11,  minQuantity:3,  unitCost:1100.0, unitPrice:1999.0, lastSale: daysAgo(0), avgMonthlySales:18,  imageEmoji:'📺', daysOutOfStockFixed:0  },
  { id:'19', sku:'MG-ARC-004', name:'Ar Condicionado 12000 BTUs',      category:'Eletrodomésticos', marketplace:'magalu',       quantity:5,   minQuantity:3,  unitCost:780.0,  unitPrice:1499.0, lastSale: daysAgo(1), avgMonthlySales:12,  imageEmoji:'❄️',  daysOutOfStockFixed:0  },
  { id:'20', sku:'MG-FRI-008', name:'Air Fryer 5L Digital',            category:'Eletrodomésticos', marketplace:'magalu',       quantity:24,  minQuantity:8,  unitCost:189.0,  unitPrice:399.9,  lastSale: daysAgo(0), avgMonthlySales:55,  imageEmoji:'🍳', daysOutOfStockFixed:0  },
  { id:'21', sku:'MG-CAF-007', name:'Cafeteira Expresso 15 Bar',       category:'Eletrodomésticos', marketplace:'magalu',       quantity:7,   minQuantity:5,  unitCost:210.0,  unitPrice:449.9,  lastSale: daysAgo(0), avgMonthlySales:28,  imageEmoji:'☕', daysOutOfStockFixed:0  },
  { id:'22', sku:'MG-LIQ-006', name:'Liquidificador 1200W Turbo',      category:'Eletrodomésticos', marketplace:'magalu',       quantity:2,   minQuantity:6,  unitCost:79.0,   unitPrice:189.9,  lastSale: daysAgo(3), avgMonthlySales:35,  imageEmoji:'🥤', daysOutOfStockFixed:0  },
  // ── Americanas ────────────────────────────────────────────────────────────
  { id:'23', sku:'AM-PER-001', name:'Perfume Masculino 100ml',         category:'Beleza',           marketplace:'americanas',   quantity:33,  minQuantity:10, unitCost:120.0,  unitPrice:299.9,  lastSale: daysAgo(0), avgMonthlySales:65,  imageEmoji:'🧴', daysOutOfStockFixed:0  },
  { id:'24', sku:'AM-TEN-004', name:'Tênis Casual Feminino',           category:'Moda',             marketplace:'americanas',   quantity:18,  minQuantity:8,  unitCost:75.0,   unitPrice:179.9,  lastSale: daysAgo(0), avgMonthlySales:48,  imageEmoji:'👟', daysOutOfStockFixed:0  },
  { id:'25', sku:'AM-BOL-006', name:'Bolsa Feminina Couro Sintético',  category:'Moda',             marketplace:'americanas',   quantity:0,   minQuantity:6,  unitCost:58.0,   unitPrice:149.9,  lastSale: daysAgo(4), avgMonthlySales:40,  imageEmoji:'👜', daysOutOfStockFixed:4  },
  { id:'26', sku:'AM-CAM-005', name:'Camiseta Polo Masculina',         category:'Moda',             marketplace:'americanas',   quantity:61,  minQuantity:15, unitCost:28.0,   unitPrice:79.9,   lastSale: daysAgo(0), avgMonthlySales:110, imageEmoji:'👕', daysOutOfStockFixed:0  },
  // ── Casas Bahia ───────────────────────────────────────────────────────────
  { id:'27', sku:'CB-SOF-001', name:'Sofá Retrátil 3 Lugares',        category:'Móveis',           marketplace:'casasbabia',   quantity:4,   minQuantity:2,  unitCost:899.0,  unitPrice:1899.0, lastSale: daysAgo(1), avgMonthlySales:8,   imageEmoji:'🛋️',  daysOutOfStockFixed:0  },
  { id:'28', sku:'CB-CAM-002', name:'Cama Box Casal Molas',            category:'Móveis',           marketplace:'casasbabia',   quantity:6,   minQuantity:2,  unitCost:599.0,  unitPrice:1299.0, lastSale: daysAgo(0), avgMonthlySales:10,  imageEmoji:'🛏️',  daysOutOfStockFixed:0  },
  { id:'29', sku:'CB-MES-003', name:'Mesa de Jantar 6 Lugares',        category:'Móveis',           marketplace:'casasbabia',   quantity:3,   minQuantity:2,  unitCost:699.0,  unitPrice:1599.0, lastSale: daysAgo(2), avgMonthlySales:7,   imageEmoji:'🪑', daysOutOfStockFixed:0  },
  { id:'30', sku:'CB-GUA-004', name:'Guarda-Roupa 6 Portas',           category:'Móveis',           marketplace:'casasbabia',   quantity:0,   minQuantity:2,  unitCost:459.0,  unitPrice:999.0,  lastSale: daysAgo(6), avgMonthlySales:9,   imageEmoji:'🚪', daysOutOfStockFixed:6  },
]
